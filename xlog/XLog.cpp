...
void XLogMgr::InitLog(const std::string& path, const std::string& filename_pre, const std::string& logger_name)
{
    ...
    try {
        ...
        //加密日志后缀为slog
        log_path = log_path.replace(".log",".slog");
#ifdef _WIN32
...
//int XLogMgr::Decrypt(const QString &log_file)
//{
...
//    int index_find = 0;
//    for (;;) {
//        index_find = slog.indexOf(QByteArray(4,'\0'),index_find);
//        if (index_find != -1) {
//            head_list.append(index_find);
//            index_find += 4;
//        } else {
//            break;
//        }
...
//        uint32_t size = *((uint32_t*)(slog.data()+head_list.at(i)+4));
//        if (size == std::numeric_limits<uint32_t>::max()) {

//        } else {
//            data = (uint8_t*)(slog.data()+head_list.at(i)+8);
//        }

//        mbedtls_chacha20_context ctx;
//        mbedtls_chacha20_init(&ctx);
//        mbedtls_chacha20_setkey(&ctx,defaultKey);
//        mbedtls_chacha20_starts(&ctx,defaultNonce,0);
