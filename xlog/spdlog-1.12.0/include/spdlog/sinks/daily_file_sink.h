 ...
 */
template<typename Mutex, typename FileHelper = details::file_helper, typename FileNameCalc = daily_filename_calculator>
...
private:
    ...
    /*details::file_helper*/FileHelper file_helper_;
    bool truncate_;
    uint16_t max_files_;
